  ...
  >
    <form @submit.prevent="onSubmit" class="scrollbar-form relative w-full">
      ...
      <div class="mt-8 flex flex-col">
        <h4
          class="mb-2 w-fit border-b border-dark-medium text-lg font-bold text-primary dark:border-light-medium dark:text-primary/50"
        >
          Datos generales
        </h4>
        ...
        <div class="mb-4 flex w-full gap-4 lg:gap-8">
          ...
          <div class="mb-2 w-1/2">
            <h5 class="mb-2 w-fit text-primary dark:text-primary/50">Contacto 2</h5>
...
.v-calendar .input-field input {
  @apply input-bordered input w-full border-light-strong bg-light-medium text-[0.9rem] dark:bg-dark-medium;
  padding-left: 2rem;
  padding-right: 0;
