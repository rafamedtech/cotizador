...
const invoiceObject = reactive({
  invId: currentInvoice.value.invId,
  ...
  invoiceDate: currentInvoice.value.invoiceDate,
  invoiceDateUnix: currentInvoice.value.invoiceDateUnix,
  paymentTerms: currentInvoice.value.paymentTerms,
  paymentDueDate: currentInvoice.value.paymentDueDate,
  paymentDueDateUnix: currentInvoice.value.paymentDueDateUnix,
  condition: currentInvoice.value.condition,
  paymentType: currentInvoice.value.paymentType,
  featureType: currentInvoice.value.featureType,
  invoiceItem: currentInvoice.value.invoiceItem,
              ...
              <div class="flex w-full gap-8">
                ...
                <div class="dropdown-bottom dropdown-end dropdown form-control relative mb-4 w-1/2">
                  ...
                  <div class="form-control relative w-full">
                    <input
                      :value="invoiceObject.clientCompany"
                      ...
                      class="input-primary input w-full bg-light-medium disabled:bg-light-medium"
                      disabled
                    />
                ...
                <div class="form-control relative mb-4 h-full w-1/2 items-end">
                  ...
                  <div class="form-control relative flex w-full flex-row">
                    ...
                    <button
                      type="button"
                      class="status-button flex h-12 items-center justify-center border-light-medium"
                      :class="{
