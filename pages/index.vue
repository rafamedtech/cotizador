...
const { contactData, searchQuery } = storeToRefs(store);
...
<template>
  <Transition name="slide" appear>
    <main class="custom-container grid place-content-center pb-[8rem]">
      ...
      <div
        class="stats stats-vertical my-4 min-w-[20rem] border shadow-pinterest transition-all delay-200 lg:stats-horizontal dark:border-dark-medium dark:bg-dark-strong md:min-w-[30rem] lg:w-[50rem]"
      >
      ...
      <div
        class="stats stats-vertical mb-4 border shadow-pinterest lg:stats-horizontal dark:border-dark-medium dark:bg-dark-strong"
      >
        <div class="stat place-items-center">
      ...
      <section class="mt-8 flex flex-col gap-4">
        ...
        <div
          ...
          class="stats stats-vertical w-full text-dark-medium shadow-pinterest dark:bg-dark-strong"
        >
