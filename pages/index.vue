  ...
  <main class="custom-container grid w-full place-content-center pb-[8rem]">
    ...
    <section class="container mt-8 flex flex-col gap-4">
      ...
      <div
        ...
        class="stats stats-vertical w-full max-w-2xl text-dark-medium shadow-pinterest"
      >
        <div class="stat lg:flex" v-for="contact in uniqueContacts">
          <div class="w-1/2">
            <div class="stat-title text-base text-primary">Empresa</div>
            <div class="stat-value text-lg">{{ contact?.clientCompany }}</div>
          </div>
          <div class="w-1/2">
            <div class="stat-title text-base text-primary">Contacto</div>
            <div class="stat-value text-lg text-dark-medium">{{ contact?.clientName }}</div>
          </div>
        </div>
      </div>
      <div
