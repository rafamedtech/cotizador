  ...
  <div class="custom-container">
    <div>
      ...
      <div class="w-full">
        ...
        <section
          class="relative mt-8 hidden w-full items-center justify-between rounded-2xl px-4 py-7 text-primary transition-all duration-300 focus:outline-primary lg:flex lg:px-8"
        >
